...
// Fetch products with image, name, and price
$sql = "SELECT id, image1, name, price FROM products_table";
...
<head>
    ...
    <title>All Products - Texura</title>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-3">
                    <div class="product-card">
                        ...
                        <form method="POST" action="shop.php">
                            ...
                            <button type="submit" name="add_to_cart" class="btn btn-sm bg-dark text-white">Add to Cart</button>
                        </form>
                    </div>
                </div>
            <?php }
